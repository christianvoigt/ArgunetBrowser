 ...
 */
(function(r,g){var n="backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",k=/^([\-+])=\s*(\d+\.?\d*)/,j=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(s){return[s[1],s[2],s[3],s[4]]}},{re:/rgba?\(\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(s){return[s[1]*2.55,s[2]*2.55,s[3]*2.55,s[4]]}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(s){return[parseInt(s[1],16),parseInt(s[2],16),parseInt(s[3],16)]}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(s){return[parseInt(s[1]+s[1],16),parseInt(s[2]+s[2],16),parseInt(s[3]+s[3],16)]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(s){return[s[1],s[2]/100,s[3]/100,s[4]]
}}],h=r.Color=function(t,u,s,v){return new r.Color.fn.parse(t,u,s,v)},m={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},q={"byte":{floor:true,max:255},percent:{max:1},degrees:{mod:360,floor:true}},p=h.support={},e=r("<p>")[0],d,o=r.each;e.style.cssText="background-color:rgba(1,1,1,.5)";p.rgba=e.style.backgroundColor.indexOf("rgba")>-1;o(m,function(s,t){t.cache="_"+s;t.props.alpha={idx:3,type:"percent",def:1}});function l(t,v,u){var s=q[v.type]||{};if(t==null){return(u||!v.def)?null:v.def}t=s.floor?~~t:parseFloat(t);if(isNaN(t)){return v.def}if(s.mod){return(t+s.mod)%s.mod}return 0>t?0:s.max<t?s.max:t}function i(s){var u=h(),t=u._rgba=[];s=s.toLowerCase();o(j,function(z,A){var x,y=A.re.exec(s),w=y&&A.parse(y),v=A.space||"rgba";if(w){x=u[v](w);u[m[v].cache]=x[m[v].cache];t=u._rgba=x._rgba;return false}});if(t.length){if(t.join()==="0,0,0,0"){r.extend(t,d.transparent)}return u}return d[s]}h.fn=r.extend(h.prototype,{parse:function(y,w,s,x){if(y===g){this._rgba=[null,null,null,null];return this}if(y.jquery||y.nodeType){y=r(y).css(w);w=g}var v=this,u=r.type(y),t=this._rgba=[];if(w!==g){y=[y,w,s,x];u="array"}if(u==="string"){return this.parse(i(y)||d._default)}if(u==="array"){o(m.rgba.props,function(z,A){t[A.idx]=l(y[A.idx],A)});return this}if(u==="object"){if(y instanceof h){o(m,function(z,A){if(y[A.cache]){v[A.cache]=y[A.cache].slice()}})}else{o(m,function(A,B){var z=B.cache;o(B.props,function(C,D){if(!v[z]&&B.to){if(C==="alpha"||y[C]==null){return}v[z]=B.to(v._rgba)}v[z][D.idx]=l(y[C],D,true)});if(v[z]&&r.inArray(null,v[z].slice(0,3))<0){v[z][3]=1;if(B.from){v._rgba=B.from(v[z])}}})}return this}},is:function(u){var s=h(u),v=true,t=this;o(m,function(w,y){var z,x=s[y.cache];if(x){z=t[y.cache]||y.to&&y.to(t._rgba)||[];o(y.props,function(A,B){if(x[B.idx]!=null){v=(x[B.idx]===z[B.idx]);return v}})}return v});return v},_space:function(){var s=[],t=this;o(m,function(u,v){if(t[v.cache]){s.push(u)}});return s.pop()},transition:function(t,z){var u=h(t),v=u._space(),w=m[v],x=this.alpha()===0?h("transparent"):this,y=x[w.cache]||w.to(x._rgba),s=y.slice();u=u[w.cache];o(w.props,function(D,F){var C=F.idx,B=y[C],A=u[C],E=q[F.type]||{};if(A===null){return}if(B===null){s[C]=A}else{if(E.mod){if(A-B>E.mod/2){B+=E.mod}else{if(B-A>E.mod/2){B-=E.mod}}}s[C]=l((A-B)*z+B,F)}});return this[v](s)},blend:function(v){if(this._rgba[3]===1){return this}var u=this._rgba.slice(),t=u.pop(),s=h(v)._rgba;return h(r.map(u,function(w,x){return(1-t)*s[x]+t*w}))},toRgbaString:function(){var t="rgba(",s=r.map(this._rgba,function(u,w){return u==null?(w>2?1:0):u});if(s[3]===1){s.pop();t="rgb("}return t+s.join()+")"},toHslaString:function(){var t="hsla(",s=r.map(this.hsla(),function(u,w){if(u==null){u=w>2?1:0}if(w&&w<3){u=Math.round(u*100)+"%"}return u});if(s[3]===1){s.pop();t="hsl("}return t+s.join()+")"},toHexString:function(s){var t=this._rgba.slice(),u=t.pop();if(s){t.push(~~(u*255))}return"#"+r.map(t,function(w){w=(w||0).toString(16);return w.length===1?"0"+w:w}).join("")},toString:function(){return this._rgba[3]===0?"transparent":this.toRgbaString()}});h.fn.parse.prototype=h.fn;function f(u,t,s){s=(s+1)%1;if(s*6<1){return u+(t-u)*s*6}if(s*2<1){return t}if(s*3<2){return u+(t-u)*((2/3)-s)*6}return u}m.hsla.to=function(v){if(v[0]==null||v[1]==null||v[2]==null){return[null,null,null,v[3]]}var t=v[0]/255,y=v[1]/255,z=v[2]/255,B=v[3],A=Math.max(t,y,z),w=Math.min(t,y,z),C=A-w,D=A+w,u=D*0.5,x,E;if(w===A){x=0}else{if(t===A){x=(60*(y-z)/C)+360}else{if(y===A){x=(60*(z-t)/C)+120}else{x=(60*(t-y)/C)+240}}}if(C===0){E=0}else{if(u<=0.5){E=C/D}else{E=C/(2-D)}}return[Math.round(x)%360,E,u,B==null?1:B]};m.hsla.from=function(x){if(x[0]==null||x[1]==null||x[2]==null){return[null,null,null,x[3]]}var w=x[0]/360,v=x[1],u=x[2],t=x[3],y=u<=0.5?u*(1+v):u+v-u*v,z=2*u-y;return[Math.round(f(z,y,w+(1/3))*255),Math.round(f(z,y,w)*255),Math.round(f(z,y,w-(1/3))*255),t]
};o(m,function(t,v){var u=v.props,s=v.cache,x=v.to,w=v.from;h.fn[t]=function(C){if(x&&!this[s]){this[s]=x(this._rgba)}if(C===g){return this[s].slice()}var z,B=r.type(C),y=(B==="array"||B==="object")?C:arguments,A=this[s].slice();o(u,function(D,F){var E=y[B==="object"?D:F.idx];if(E==null){E=A[F.idx]}A[F.idx]=l(E,F)});if(w){z=h(w(A));z[s]=A;return z}else{return h(A)}};o(u,function(y,z){if(h.fn[y]){return}h.fn[y]=function(D){var F=r.type(D),C=(y==="alpha"?(this._hsla?"hsla":"rgba"):t),B=this[C](),E=B[z.idx],A;if(F==="undefined"){return E}if(F==="function"){D=D.call(this,E);F=r.type(D)}if(D==null&&z.empty){return this}if(F==="string"){A=k.exec(D);if(A){D=E+parseFloat(A[2])*(A[1]==="+"?1:-1)}}B[z.idx]=D;return this[C](B)}})});h.hook=function(t){var s=t.split(" ");o(s,function(u,v){r.cssHooks[v]={set:function(z,A){var x,y,w="";if(A!=="transparent"&&(r.type(A)!=="string"||(x=i(A)))){A=h(x||A);if(!p.rgba&&A._rgba[3]!==1){y=v==="backgroundColor"?z.parentNode:z;while((w===""||w==="transparent")&&y&&y.style){try{w=r.css(y,"backgroundColor");y=y.parentNode}catch(B){}}A=A.blend(w&&w!=="transparent"?w:"_default")}A=A.toRgbaString()}try{z.style[v]=A}catch(B){}}};r.fx.step[v]=function(w){if(!w.colorInit){w.start=h(w.elem,v);w.end=h(w.end);w.colorInit=true}r.cssHooks[v].set(w.elem,w.start.transition(w.end,w.pos))}})};h.hook(n);r.cssHooks.borderColor={expand:function(t){var s={};o(["Top","Right","Bottom","Left"],function(v,u){s["border"+u+"Color"]=t});return s}};d=r.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(jQuery);(function(){var e=["add","remove","toggle"],f={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};a.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(h,i){a.fx.step[i]=function(j){if(j.end!=="none"&&!j.setAttr||j.pos===1&&!j.setAttr){jQuery.style(j.elem,i,j.end);j.setAttr=true}}});function g(l){var i,h,j=l.ownerDocument.defaultView?l.ownerDocument.defaultView.getComputedStyle(l,null):l.currentStyle,k={};if(j&&j.length&&j[0]&&j[j[0]]){h=j.length;while(h--){i=j[h];if(typeof j[i]==="string"){k[a.camelCase(i)]=j[i]}}}else{for(i in j){if(typeof j[i]==="string"){k[i]=j[i]}}}return k}function d(h,j){var l={},i,k;for(i in j){k=j[i];if(h[i]!==k){if(!f[i]){if(a.fx.step[i]||!isNaN(parseFloat(k))){l[i]=k}}}}return l}if(!a.fn.addBack){a.fn.addBack=function(h){return this.add(h==null?this.prevObject:this.prevObject.filter(h))}}a.effects.animateClass=function(h,i,l,k){var j=a.speed(i,l,k);return this.queue(function(){var o=a(this),m=o.attr("class")||"",n,p=j.children?o.find("*").addBack():o;p=p.map(function(){var q=a(this);return{el:q,start:g(this)}});n=function(){a.each(e,function(q,r){if(h[r]){o[r+"Class"](h[r])}})};n();p=p.map(function(){this.end=g(this.el[0]);this.diff=d(this.start,this.end);return this});o.attr("class",m);p=p.map(function(){var s=this,q=a.Deferred(),r=a.extend({},j,{queue:false,complete:function(){q.resolve(s)}});this.el.animate(this.diff,r);return q.promise()});a.when.apply(a,p.get()).done(function(){n();a.each(arguments,function(){var q=this.el;a.each(this.diff,function(r){q.css(r,"")})});j.complete.call(o[0])})})};a.fn.extend({addClass:(function(h){return function(j,i,l,k){return i?a.effects.animateClass.call(this,{add:j},i,l,k):h.apply(this,arguments)}})(a.fn.addClass),removeClass:(function(h){return function(j,i,l,k){return arguments.length>1?a.effects.animateClass.call(this,{remove:j},i,l,k):h.apply(this,arguments)}})(a.fn.removeClass),toggleClass:(function(h){return function(k,j,i,m,l){if(typeof j==="boolean"||j===c){if(!i){return h.apply(this,arguments)}else{return a.effects.animateClass.call(this,(j?{add:k}:{remove:k}),i,m,l)}}else{return a.effects.animateClass.call(this,{toggle:k},j,i,m)
}}})(a.fn.toggleClass),switchClass:function(h,j,i,l,k){return a.effects.animateClass.call(this,{add:j,remove:h},i,l,k)}})})();(function(){a.extend(a.effects,{version:"@VERSION",save:function(g,h){for(var f=0;f<h.length;f++){if(h[f]!==null){g.data(b+h[f],g[0].style[h[f]])}}},restore:function(g,j){var h,f;for(f=0;f<j.length;f++){if(j[f]!==null){h=g.data(b+j[f]);if(h===c){h=""}g.css(j[f],h)}}},setMode:function(f,g){if(g==="toggle"){g=f.is(":hidden")?"show":"hide"}return g},getBaseline:function(g,h){var i,f;switch(g[0]){case"top":i=0;break;case"middle":i=0.5;break;case"bottom":i=1;break;default:i=g[0]/h.height}switch(g[1]){case"left":f=0;break;case"center":f=0.5;break;case"right":f=1;break;default:f=g[1]/h.width}return{x:f,y:i}},createWrapper:function(g){if(g.parent().is(".ui-effects-wrapper")){return g.parent()}var h={width:g.outerWidth(true),height:g.outerHeight(true),"float":g.css("float")},k=a("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),f={width:g.width(),height:g.height()},j=document.activeElement;try{j.id}catch(i){j=document.body}g.wrap(k);if(g[0]===j||a.contains(g[0],j)){a(j).focus()}k=g.parent();if(g.css("position")==="static"){k.css({position:"relative"});g.css({position:"relative"})}else{a.extend(h,{position:g.css("position"),zIndex:g.css("z-index")});a.each(["top","left","bottom","right"],function(l,m){h[m]=g.css(m);if(isNaN(parseInt(h[m],10))){h[m]="auto"}});g.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})}g.css(f);return k.css(h).show()},removeWrapper:function(f){var g=document.activeElement;if(f.parent().is(".ui-effects-wrapper")){f.parent().replaceWith(f);if(f[0]===g||a.contains(f[0],g)){a(g).focus()}}return f},setTransition:function(g,i,f,h){h=h||{};a.each(i,function(k,j){var l=g.cssUnit(j);if(l[0]>0){h[j]=l[0]*f+l[1]}});return h}});function d(g,f,h,i){if(a.isPlainObject(g)){f=g;g=g.effect}g={effect:g};if(f==null){f={}}if(a.isFunction(f)){i=f;h=null;f={}}if(typeof f==="number"||a.fx.speeds[f]){i=h;h=f;f={}}if(a.isFunction(h)){i=h;h=null}if(f){a.extend(g,f)}h=h||f.duration;g.duration=a.fx.off?0:typeof h==="number"?h:h in a.fx.speeds?a.fx.speeds[h]:a.fx.speeds._default;g.complete=i||f.complete;return g}function e(f){if(!f||typeof f==="number"||a.fx.speeds[f]){return true}if(typeof f==="string"&&!a.effects.effect[f]){return true}if(a.isFunction(f)){return true}if(typeof f==="object"&&!f.effect){return true}return false}a.fn.extend({effect:function(){var h=d.apply(this,arguments),j=h.mode,f=h.queue,g=a.effects.effect[h.effect];if(a.fx.off||!g){if(j){return this[j](h.duration,h.complete)}else{return this.each(function(){if(h.complete){h.complete.call(this)}})}}function i(m){var n=a(this),l=h.complete,o=h.mode;function k(){if(a.isFunction(l)){l.call(n[0])}if(a.isFunction(m)){m()}}if(n.is(":hidden")?o==="hide":o==="show"){n[o]();k()}else{g.call(n[0],h,k)}}return f===false?this.each(i):this.queue(f||"fx",i)},show:(function(f){return function(h){if(e(h)){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="show";return this.effect.call(this,g)}}})(a.fn.show),hide:(function(f){return function(h){if(e(h)){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="hide";return this.effect.call(this,g)}}})(a.fn.hide),toggle:(function(f){return function(h){if(e(h)||typeof h==="boolean"){return f.apply(this,arguments)}else{var g=d.apply(this,arguments);g.mode="toggle";return this.effect.call(this,g)}}})(a.fn.toggle),cssUnit:function(f){var g=this.css(f),h=[];a.each(["em","px","%","pt"],function(j,k){if(g.indexOf(k)>0){h=[parseFloat(g),k]}});return h}})})();(function(){var d={};a.each(["Quad","Cubic","Quart","Quint","Expo"],function(f,e){d[e]=function(g){return Math.pow(g,f+2)}});a.extend(d,{Sine:function(e){return 1-Math.cos(e*Math.PI/2)},Circ:function(e){return 1-Math.sqrt(1-e*e)},Elastic:function(e){return e===0||e===1?e:-Math.pow(2,8*(e-1))*Math.sin(((e-1)*80-7.5)*Math.PI/15)},Back:function(e){return e*e*(3*e-2)
},Bounce:function(g){var e,f=4;while(g<((e=Math.pow(2,--f))-1)/11){}return 1/Math.pow(4,3-f)-7.5625*Math.pow((e*3-2)/22-g,2)}});a.each(d,function(f,e){a.easing["easeIn"+f]=e;a.easing["easeOut"+f]=function(g){return 1-e(1-g)};a.easing["easeInOut"+f]=function(g){return g<0.5?e(g*2)/2:1-e(g*-2+2)/2}})})()})(jQuery);(function(d,e){var b=0,c={},a={};c.height=c.paddingTop=c.paddingBottom=c.borderTopWidth=c.borderBottomWidth="hide";a.height=a.paddingTop=a.paddingBottom=a.borderTopWidth=a.borderBottomWidth="show";d.widget("ui.accordion",{version:"@VERSION",options:{active:0,animate:{},collapsible:false,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},_create:function(){var f=this.options;this.prevShow=this.prevHide=d();this.element.addClass("ui-accordion ui-widget ui-helper-reset").attr("role","tablist");if(!f.collapsible&&(f.active===false||f.active==null)){f.active=0}this._processPanels();if(f.active<0){f.active+=this.headers.length}this._refresh()},_getCreateEventData:function(){return{header:this.active,panel:!this.active.length?d():this.active.next()}},_createIcons:function(){var f=this.options.icons;if(f){d("<span>").addClass("ui-accordion-header-icon ui-icon "+f.header).prependTo(this.headers);this.active.children(".ui-accordion-header-icon").removeClass(f.header).addClass(f.activeHeader);this.headers.addClass("ui-accordion-icons")}},_destroyIcons:function(){this.headers.removeClass("ui-accordion-icons").children(".ui-accordion-header-icon").remove()},_destroy:function(){var f;this.element.removeClass("ui-accordion ui-widget ui-helper-reset").removeAttr("role");this.headers.removeClass("ui-accordion-header ui-accordion-header-active ui-state-default ui-corner-all ui-state-active ui-state-disabled ui-corner-top").removeAttr("role").removeAttr("aria-selected").removeAttr("aria-controls").removeAttr("tabIndex").each(function(){if(/^ui-accordion/.test(this.id)){this.removeAttribute("id")}});this._destroyIcons();f=this.headers.next().css("display","").removeAttr("role").removeAttr("aria-expanded").removeAttr("aria-hidden").removeAttr("aria-labelledby").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accordion-content-active ui-state-disabled").each(function(){if(/^ui-accordion/.test(this.id)){this.removeAttribute("id")}});if(this.options.heightStyle!=="content"){f.css("height","")}},_setOption:function(f,g){if(f==="active"){this._activate(g);return}if(f==="event"){if(this.options.event){this._off(this.headers,this.options.event)}this._setupEvents(g)}this._super(f,g);if(f==="collapsible"&&!g&&this.options.active===false){this._activate(0)}if(f==="icons"){this._destroyIcons();if(g){this._createIcons()}}if(f==="disabled"){this.element.toggleClass("ui-state-disabled",!!g).attr("aria-disabled",g);this.headers.add(this.headers.next()).toggleClass("ui-state-disabled",!!g)}},_keydown:function(i){if(i.altKey||i.ctrlKey){return}var j=d.ui.keyCode,h=this.headers.length,f=this.headers.index(i.target),g=false;switch(i.keyCode){case j.RIGHT:case j.DOWN:g=this.headers[(f+1)%h];break;case j.LEFT:case j.UP:g=this.headers[(f-1+h)%h];break;case j.SPACE:case j.ENTER:this._eventHandler(i);break;case j.HOME:g=this.headers[0];break;case j.END:g=this.headers[h-1];break}if(g){d(i.target).attr("tabIndex",-1);d(g).attr("tabIndex",0);g.focus();i.preventDefault()}},_panelKeyDown:function(f){if(f.keyCode===d.ui.keyCode.UP&&f.ctrlKey){d(f.currentTarget).prev().focus()}},refresh:function(){var f=this.options;this._processPanels();if((f.active===false&&f.collapsible===true)||!this.headers.length){f.active=false;this.active=d()}else{if(f.active===false){this._activate(0)}else{if(this.active.length&&!d.contains(this.element[0],this.active[0])){if(this.headers.length===this.headers.find(".ui-state-disabled").length){f.active=false;this.active=d()}else{this._activate(Math.max(0,f.active-1))}}else{f.active=this.headers.index(this.active)
...
},oval:function(r,v,s,u,t){t=t||{};f.prototype._draw(r,v,s,u,t)},line:function(s,v,r,t,u){var w=new a(s,v,r,t);w.draw(u)},lines:function(s,u,r,t){if(typeof t=="number"){k.push([{x:s,y:u},{x:r,y:t}])}else{k.push([s,u])}},drawLines:function(r){var s=new a(k);s.draw(r);k=[]}};return j.init()};arbor=(typeof(arbor)!=="undefined")?arbor:{};$.extend(arbor,{Graphics:function(ctx){return Graphics(ctx)},colors:{CSS:Colors.CSS,validate:Colors.validate,decode:Colors.decode,encode:Colors.encode,blend:Colors.blend}})})(this.jQuery);this.argunet=this.argunet||{};argunet.Argument=function(a){this.id;this.title="untitled";this.description="";this.sentences=[];this.colorIndex="0";this.group;this.relations={};this.x=0;this.y=0;this.width=0;this.height=0;$.extend(true,this,a)};argunet.Argument.prototype.addSentence=function(d,b,a){var c=new Sentence(d,b,a);this.sentences[b]=c};this.argunet=this.argunet||{};argunet.DebateManager=function(a){this.doc=$(a).get(0).ownerDocument;var b=this;var c=argunet.DebateManager.prototype;c.addEventListener=null;c.removeEventListener=null;c.removeAllEventListeners=null;c.dispatchEvent=null;c.hasEventListener=null;c._listeners=null;createjs.EventDispatcher.initialize(c);this.init=function(){this.nodes={};this.colors=[];this.groups={};this.edgesBySource={};this.edgesByTarget={};this.firstNodeId=null};this.loadDebate=function(e){this.init();var f=".graphml";if(e&&e.toLowerCase().indexOf(f,e.length-f.length)!==-1){this.loadGraphml(e)}else{var d;if(!e){d=$(a,this.doc).get(0)}else{d=$(e,this.doc).get(0)}if(d&&$(d).is(".argument-map")){this.parseHtml(d)}else{this.dispatchEvent({type:"error",textStatus:"Could not find argument map html."},this)}}};this.loadGraphml=function(d){console.log("loading graphml");$.ajax({type:"GET",url:d,dataType:"XML",success:function(e){var f;if(!window.DOMParser){f=new ActiveXObject("Microsoft.XMLDOM");f.async=false;f.loadXML(e)}else{f=e}f=$(e);b.parseGraphml(f)},error:function(e,g,f){this.dispatchEvent({type:"error",textStatus:g,errorThrown:f},this)}})};this.parseGraphml=function(e){var d=$(e).find("arg\\:debate, debate").get(0);this.debateTitle=$(d).children("arg\\:title").text();this.debateSubtitle=$(d).children("arg\\:subtitle").text();$(e).find("arg\\:color, color").each(function(){var h=$(this).attr("colorIndex");var f=$(this).attr("description");var g=$(this).attr("colorCode");b.colors[h]=b.getColorObject(h,f,g)});$(e).find("node").each(function(){var o;if($(this).children("data").children("arg\\:group").length){var s=$(this).children("data").children("arg\\:group").get(0);var t=$(s).children("arg\\:title").text();var u=$(s).attr("numberOfArguments");var f=$(s).attr("numberOfTheses");var m=$(s).attr("color");var p=$(s).attr("id");o=new argunet.Group(p,t,m,u,f);b.groups[p]=o}else{if($(this).children("data").children("arg\\:argument").length){var l=$(this).children("data").children("arg\\:argument").get(0);var n=$(l).attr("id");if(!b.firstNodeId){b.firstNodeId=n}var v=$(l).children("arg\\:title").text();var r=$(l).children("arg\\:description").text();var g=$(l).attr("colorIndex");var i={incomingAttacks:$(l).attr("incomingAttacks"),incomingSupports:$(l).attr("incomingSupports"),outgoingAttacks:$(l).attr("outgoingAttacks"),outgoingSupports:$(l).attr("outgoingSupports")};var j;if($(this).parents("node:first").length){var p=$(this).parents("node:first").children("data:first").children("arg\\:group").attr("id");b.groups[p].addNode(n);j=p}o=new argunet.Argument({id:n,title:v,description:r,colorIndex:g,group:j,relations:i});b.nodes[n]=o}else{if($(this).children("data").children("arg\\:thesis").length){var w=$(this).children("data").children("arg\\:thesis:first").get(0);var n=$(w).attr("id");var v=$(w).children("arg\\:title").text();var q=$(w).children("arg\\:content").text();var g=$(w).attr("colorIndex");var j;var i={incomingAttacks:$(w).attr("incomingAttacks"),incomingSupports:$(w).attr("incomingSupports"),outgoingAttacks:$(w).attr("outgoingAttacks"),outgoingSupports:$(w).attr("outgoingSupports")};
if($(this).parents("node:first").length){var p=$(this).parents("node:first").children("data").children("arg\\:group").first().attr("id");b.groups[p].addNode(n);j=p}o=new argunet.Thesis({id:n,title:v,content:q,colorIndex:g,group:j,relations:i});b.nodes[n]=o}}}if($(this).children("data").children("y\\:ShapeNode").length){var k=$(this).children("data").children("y\\:ShapeNode").first();var h=k.children("y\\:Geometry").first();o.x=h.attr("x");o.y=h.attr("y");o.width=h.attr("width");o.height=h.attr("height")}});$(e).find("edge:parent").each(function(){var g=$(this).children("data:first").children("arg\\:edge");var f=g.attr("type");b.addEdge($(g).attr("sourceNodeId"),$(g).attr("targetNodeId"),f,$(g).attr("sourcePropositionId"),$(g).attr("targetPropositionId"))});this.dispatchEvent({type:"debateLoaded"},this)};this.addEdge=function(g,h,f,d,e){edge=new argunet.Edge(g,h,f,d,e);if(this.edgesBySource[edge.source]==undefined){this.edgesBySource[edge.source]={}}if(this.edgesByTarget[edge.target]==undefined){this.edgesByTarget[edge.target]={}}this.edgesBySource[edge.source][edge.target]=edge;this.edgesByTarget[edge.target][edge.source]=edge;return edge};this.parseHtml=function(d){console.log("parsing html argument map");this.debateTitle=$(d).children("h3").text();this.debateSubtitle="";var f="#63aef2";this.colors[0]=this.getColorObject(0,"default 1",f);var e="#f2d863";this.colors[1]=this.getColorObject(1,"default 2",e);$(d).find(".argument, .thesis").each(function(){var m=$(this).attr("id");if(!b.firstNodeId){b.firstNodeId=m}if(!m){this.dispatchEvent("error","Found node without id, which is a required attribute.",undefined);return}var k=$(this).children("h4")?$(this).children("h4").filter(":first").text():"Untitled";var i=$(this).children("p")?$(this).children("p").filter(":first").text():"";var l=b.lookupOrAddColor($(this).data("color"))||0;var j;var g={incomingAttacks:0,incomingSupports:0,outgoingAttacks:0,outgoingSupports:0};var h;if($(this).is(".argument")){h=new argunet.Argument({id:m,title:k,description:i,colorIndex:l,group:j,relations:g})}else{h=new argunet.Thesis({id:m,title:k,content:i,colorIndex:l,group:j,relations:g})}b.nodes[m]=h});$(d).find(".support, .attack").each(function(){var i=$(this).data("from");var h=$(this).data("to");var g=$(this).is(".support")?"support":"attack";b.addEdge(i,h,g)});this.dispatchEvent({type:"debateLoaded"},this)};this.lookupOrAddColor=function(d){var e;if(!d){return e}if(!(d!=d)){d=d.toString()}if(d.indexOf("#")==-1){return this.colors[d]?d:e}$(this.colors).each(function(){if(this.baseColor==d){e=this.index;return false}});if(!e){this.colors.push(this.getColorObject(this.colors.length,"",d));e=this.colors.length-1}return e};this.getColorObject=function(f,g,h){var e=$.xcolor.lighten(h,80,1).getHex();var d=$.xcolor.darken(h,45,3).getHex();return{index:f,description:g,base:h,light:e,dark:d}};this.getNode=function(d){return this.nodes[d]};this.getColor=function(d){return this.colors[d]};this.getEdge=function(e,d){return this.edgesBySource[e][d]};this.getEdgesFrom=function(d){return this.edgesBySource[d]};this.getEdgesTo=function(d){return this.edgesByTarget[d]}};this.argunet=this.argunet||{};argunet.Edge=function(e,c,d,a,b){this.source=e;this.target=c;this.sourceProposition=a;this.targetProposition=b;this.type=d};this.argunet=this.argunet||{};argunet.Group=function(e,d,a,b,c){this.id=e;this.title=d;this.color=a;this.numberOfArguments=parseInt(b);this.numberOfTheses=parseInt(c);this.nodes=[];this.open=true};argunet.Group.prototype.addNode=function(a){this.nodes.push(a)};this.argunet=this.argunet||{};argunet.HistoryState=function(a,b){this.type=a;this.data=b};this.argunet=this.argunet||{};argunet.Sentence=function(c,b,a){if(a!="conclusion"){a="premise"}this.text=c;this.nr=b;this.type=a};this.argunet=this.argunet||{};argunet.Thesis=function(a){this.id;this.argunetId;this.title="untitled";this.content="";this.colorIndex="0";this.group;this.relations={};$.extend(true,this,a)};this.argunet=this.argunet||{};(function(){var a=function(k,l,g){var d=argunet.ArborController.prototype;
d.addEventListener=null;d.removeEventListener=null;d.removeAllEventListeners=null;d.dispatchEvent=null;d.hasEventListener=null;d._listeners=null;createjs.EventDispatcher.initialize(d);this.debateManager=l;this.arborView=k;var c={workerUrl:g,integrator:"euler",stiffness:400,repulsion:400,friction:0.7,gravity:true};this.sys=arbor.ParticleSystem(c);this.sys.parameters({integrator:"euler"});var f=new argunet.ArborConfigurator(this.sys,k.stage.canvas.width,k.stage.canvas.height);k.addEventListener("mousedown",this);this.sys.renderer=k;this.graphDepth=1;var h={};var e;var j={};var i=undefined;this.doc=this.arborView.stage.canvas.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.addNodeToVisibleGraph=function(q,n){var p=(n==0)?true:false;groupId=this.debateManager.nodes[q].group;var o=(groupId)?!this.debateManager.groups[groupId].open:false;var m=false;if(h[q]!=undefined){if(p){h[q].selected=p}h[q].inactive=o;h[q].edgesToSelectedNode=Math.min(n,h[q].edgesToSelectedNode);return}else{if(!p&&(e&&!e.nodes[q])){m=true;this.nrOfNewNodes++}}this.nrOfNodes++;h[q]={id:q,isNew:m,selected:p,inactive:o,edgesToSelectedNode:n}};this.addEdgeToVisibleGraph=function(n){var o=n.source;var q=n.target;if(j[o]!=undefined&&j[o][q]!=undefined){return}if(j[o]==undefined){j[o]={}}var m=h[n.source];var p=h[n.target];var r=Math.max(m.edgesToSelectedNode,p.edgesToSelectedNode);j[o][q]={source:o,target:q,length:1/(r*r*r),sourceModel:n.source,targetModel:n.target}};this.changeGraphDepth=function(n,o){var m=this;if(n<o){$.each(h,function(p,r){var q=r;if(q.edgesToSelectedNode==n){if(m.debateManager.getEdgesTo(q.id)!=undefined){$.each(m.debateManager.getEdgesTo(q.id),function(s,t){m.addNodeToVisibleGraph(t.source,n+1);m.addEdgeToVisibleGraph(t)})}if(m.debateManager.getEdgesFrom(q.id)!=undefined){$.each(m.debateManager.getEdgesFrom(q.id),function(s,t){m.addNodeToVisibleGraph(t.target,n+1);m.addEdgeToVisibleGraph(t)})}m.changeGraphDepth(n+1,o)}})}else{return}};this.setGraphDepth=function(m){this.graphDepth=m;this.update()};this.selectNode=function(m){if(i==m){return}i=m;this.update()};this.update=function(){h={};j={};this.nrOfNodes=0;this.nrOfNewNodes=0;this.addNodeToVisibleGraph(i,0);this.changeGraphDepth(0,this.graphDepth);f.configurate(this.nrOfNodes,this.graphDepth,this.arborView.stage.canvas.width,this.arborView.stage.canvas.height);e={nodes:h,edges:j};var o=this.sys.getNode(i);var p=(o)?o.p.x:undefined;var n=(o)?o.p.y:undefined;console.log("x: "+p+" y: "+n);var m=this;this.sys.merge(e)}};var b=a.prototype;b.handleEvent=function(c){if(c.type=="historyChange"){var e=c.state;if(e.type=="nodeSelection"){this.selectNode(e.data.nodeId)}}else{if(c.type=="graphDepthChange"){this.graphDepth=c.value;this.update()}else{if(c.type=="update"){this.update()}else{if(c.type=="openGroup"){this.debateManager.groups[c.id].open=true;this.update()}else{if(c.type=="closeGroup"){this.debateManager.groups[c.id].open=false;this.update()}else{if(c.type=="openAllGroups"){$.each(this.debateManager.groups,function(){this.open=true});this.update()}else{if(c.type=="closeAllGroups"){$.each(this.debateManager.groups,function(){this.open=false});this.update()}else{if(c.type=="resize"||c.type=="fullscreenchange"||c.type=="mozfullscreenchange"||c.type=="webkitfullscreenchange"){var d=this;if(this.doc.mozFullScreen||this.doc.webkitIsFullScreen){d.update();this.oldWidth=d.arborView.stage.canvas.width;this.oldHeight=d.arborView.stage.canvas.height}else{if(!this.oldWidth||!this.oldHeight||this.oldWidth!=d.arborView.stage.canvas.width||this.oldHeight!=d.arborView.stage.canvas.height){d.update();this.oldWidth=d.arborView.stage.canvas.width;this.oldHeight=d.arborView.stage.canvas.height}}}}}}}}}}};argunet.ArborController=a}());this.argunet=this.argunet||{};
(function(){var b=function(c,d){var e=argunet.StaticGraphController.prototype;e.addEventListener=null;e.removeEventListener=null;e.removeAllEventListeners=null;e.dispatchEvent=null;e.hasEventListener=null;e._listeners=null;createjs.EventDispatcher.initialize(e);this.debateManager=d;this.view=c;c.addEventListener("mousedown",this);this.doc=this.view.stage.canvas.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.selectNode=function(f){};this.update=function(){this.view.redraw(this.debateManager.nodes,this.debateManager.edgesBySource,this.debateManager.colors)};this.update()};var a=b.prototype;a.handleEvent=function(c){if(c.type=="historyChange"){var e=c.state;if(e.type=="nodeSelection"){this.selectNode(e.data.nodeId)}}else{if(c.type=="openGroup"){this.debateManager.groups[c.id].open=true;this.update()}else{if(c.type=="closeGroup"){this.debateManager.groups[c.id].open=false;this.update()}else{if(c.type=="openAllGroups"){$.each(this.debateManager.groups,function(){this.open=true});this.update()}else{if(c.type=="closeAllGroups"){$.each(this.debateManager.groups,function(){this.open=false});this.update()}else{if(c.type=="resize"||c.type=="fullscreenchange"||c.type=="mozfullscreenchange"||c.type=="webkitfullscreenchange"){var d=this;if(this.doc.mozFullScreen||this.doc.webkitIsFullScreen){d.update();this.oldWidth=d.view.stage.canvas.width;this.oldHeight=d.view.stage.canvas.height}else{if(!this.oldWidth||!this.oldHeight||this.oldWidth!=d.view.stage.canvas.width||this.oldHeight!=d.view.stage.canvas.height){d.update();this.oldWidth=d.view.stage.canvas.width;this.oldHeight=d.view.stage.canvas.height}}}}}}}}};argunet.StaticGraphController=b}());this.argunet=this.argunet||{};(function(){var a=function(b){var c=b;this.configurate=function(e,g,i,d){var j=400;var h=400;var k=0.7;var l=Math.max(0,i-640)/(1440-640);console.log("repulsion: "+j+" stiffness: "+h+" friction: "+k);c.parameters({repulsion:j,stiffness:h,friction:k,gravity:true});c.screenSize(i,d)}};argunet.ArborConfigurator=a}());this.argunet=this.argunet||{};argunet.BrowserRegistry=function(a){if(arguments.callee.instance){return arguments.callee.instance}arguments.callee.instance=this;this.w=a;this.w.argunet=a.argunet||{};this.w.argunet.browsers=a.argunet.browsers||[];var b=function(){var c=[];var d=/.*ArgunetBrowser\.load\.([^/]+\.)?js/;$("script",a.document).each(function(){if($(this).attr("src")&&$(this).attr("src").match(d)){c.push(this)}});return c};a.argunet.scriptTags=a.argunet.scriptTags||b();this.browsers=[];this.registerBrowser=function(c){this.w.argunet.browsers.push(c);return this.w.argunet.browsers.length};this.getScriptTag=function(c){return this.w.argunet.scriptTags[c-1]}};argunet.BrowserRegistry.getInstance=function(b){var a=new argunet.BrowserRegistry(b);return a};this.argunet=this.argunet||{};(function(){var a=function(c,d){this.view=c;this.manager=d;var e=this;var b={};var g=[];var f=function(l,i){var h=e.manager.getNode(l);var k="";if(h instanceof argunet.Argument){k="Argument: "+h.title}else{if(h instanceof argunet.Thesis){k="Thesis: "+h.title}}var j={name:k,nodeId:h.id,nocheck:true};if(i!=undefined){i.children.push(j);b[l]=true}else{g.push(j)}};$.each(this.manager.groups,function(){var h={id:this.id,name:"Group: "+this.title,children:[],checked:false};$.each(this.nodes,function(){f(this,h)});g.push(h)});$.each(this.manager.nodes,function(){if(!b[this.id]){f(this.id)}});this.view.initialize(this.manager.debateTitle,this.manager.debateSubtitle,g)};argunet.DebateListController=a}());this.argunet=this.argunet||{};argunet.History=function(){var b=argunet.History.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);
var c=-1;var a=[];this.backwardEnabled=false;this.forwardEnabled=false;this.homeEnabled=false;this.addState=function(d){if(!d instanceof argunet.HistoryState){throw new Error("'state' is not an instance of argunet.HistoryState");return}c++;if(c<a.length-1){a.splice(c,a.length-c-1,d);this.forwardEnabled=false}else{a[c]=d}if(a.length>1){this.backwardEnabled=true}if(c==0){this.homeEnabled=false}else{this.homeEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.back=function(){if(!this.backwardEnabled){return}if(c>0){c--;this.forwardEnabled=true}if(c==0){this.backwardEnabled=false;this.homeEnabled=false}else{this.homeEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.forward=function(){if(!this.forwardEnabled){return}if(c<a.length-1){c++;this.backwardEnabled=true;this.homeEnabled=true}if(c==a.length-1){this.forwardEnabled=false}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.home=function(){if(!this.homeEnabled){return}c=0;this.backwardEnabled=false;this.homeEnabled=false;if(a.length>0){this.forwardEnabled=true}this.dispatchEvent({type:"historyChange",state:this.getCurrentState()},this)};this.getCurrentState=function(){return a[c]};this.selectNode=function(d){if(this.selectedNode!=undefined&&this.selectedNode==d){return}this.selectedNode=d;this.addState(new argunet.HistoryState("nodeSelection",{nodeId:d}))};this.handleEvent=function(d){if(d.type=="back"){this.back()}else{if(d.type=="home"){this.home()}else{if(d.type=="forward"){this.forward()}}}}};this.argunet=this.argunet||{};(function(){var a=function(){};var b=a.prototype=new createjs.Container();b.Container_initialize=a.prototype.initialize;b.Container_tick=a.prototype._tick;b.initialize=function(g,f,e,c){this.Container_initialize();this.nodeId=g;this.colors=c;this.title=f;this.text=e;this.state0Height=15;this.cornerRadius=8;this.styleState1={width:100,bgColor:this.colors.base,borderColor:this.colors.dark,borderWidth:1,cornerRadius:8,titleColor:this.colors.dark,titleCss:"11px Arial",textColor:this.colors.dark};this.styleState2={width:140,bgColor:this.colors.base,borderColor:this.colors.dark,borderWidth:3,cornerRadius:8,titleColor:this.colors.dark,titleCss:"bold 11px Arial",textColor:this.colors.dark,textCss:"11px Arial"};this.styleState0={cornerRadius:8};this.paddingState1={top:4,left:4,bottom:4,right:4};this.paddingState2={top:8,left:8,bottom:8,right:8};this.marginState1={top:1,right:1,bottom:1,left:1};this.marginState2={top:2,right:2,bottom:2,left:2};var d=this;this.addEventListener("mousedown",this)};b.handleEvent=function(c){if(c.type=="mousedown"){this.lastMousedown=new Date().getTime();var d=this;c.onMouseMove=function(e){e.target.x=e.stageX;e.target.y=e.stageY;d.dispatchEvent("drag",d)};c.onMouseUp=function(e){var f=new Date().getTime();if(f-d.lastMousedown<200){d.dispatchEvent("select",d)}d.dispatchEvent("drop",d)}}};b.render=function(){this.state0=new createjs.Container();this.state0inactive=new createjs.Container();this.state1=new createjs.Container();this.state2=new createjs.Container();this.addChild(this.state0);this.addChild(this.state0inactive);this.addChild(this.state1);this.addChild(this.state2);var h=new createjs.Graphics();h.beginFill(this.styleState1.bgColor);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke(this.styleState1.borderColor);h.drawRoundRect(0,0,this.state0Height,this.state0Height,this.styleState0.cornerRadius);var f=new createjs.Shape(h);f.x=-this.state0Height/2;f.y=-this.state0Height/2;this.state0.addChild(f);var e="#dddddd";var h=new createjs.Graphics();h.beginFill(e);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke("#bbbbbb");h.drawRoundRect(0,0,this.state0Height,this.state0Height,this.styleState0.cornerRadius);var g=new createjs.Shape(h);g.x=-this.state0Height/2;g.y=-this.state0Height/2;this.state0inactive.addChild(g);var c=new createjs.Text(this.shortenWords(this.title,17,"."),this.styleState1.titleCss,this.styleState1.titleColor);
c.lineWidth=this.styleState1.width-this.paddingState1.left-this.paddingState1.right;c.textAlign="center";this.state1Height=c.getMeasuredHeight()+this.paddingState1.top+this.paddingState1.bottom;var h=new createjs.Graphics();h.beginFill(this.styleState1.bgColor);h.setStrokeStyle(this.styleState1.borderWidth).beginStroke(this.styleState1.borderColor);h.drawRoundRect(0,0,this.styleState1.width,this.state1Height,this.styleState2.cornerRadius);var d=new createjs.Shape(h);d.x=-this.styleState1.width/2;d.y=-this.state1Height/2;this.state1.addChild(d);c.x=d.x+this.styleState1.width/2;c.y=d.y+this.paddingState1.top;this.state1.addChild(c);this.renderState2();this.deselect()};b.shortenString=function(e,d,c){return(e.length>d)?e.substring(0,e.length-(e.length-d))+c:e};b.shortenWords=function(h,d,c){var f="";var g=h.split(" ");var e=this;$.each(g,function(j,m){var k=m;if(m.length>d){hyphenIndex=m.indexOf("-");slashIndex=m.indexOf("/");if((-1<hyphenIndex&&hyphenIndex<m.length-1)||(-1<slashIndex&&slashIndex<m.length-1)){k=e.shortenWords(m.replace("-","- ").replace("/","/ "),d,c)}else{k=e.shortenString(m,d,c)}}var l=(f=="")?"":" ";f+=l+k});return f};b.renderState2=function(){this.state2Height=this.paddingState2.top+this.paddingState2.bottom;if(this.title!=""&&this.title.toLowerCase()!="untitled"){var g=new createjs.Text(this.shortenWords(this.title,24,"."),this.styleState2.titleCss,this.styleState2.titleColor);g.lineWidth=this.styleState2.width-this.paddingState2.left-this.paddingState2.right;g.textAlign="center";this.state2Height+=g.getMeasuredHeight()}if(this.text!=""){var d=this.shortenWords(this.shortenString(this.text,200,"."),24," ...");var f=new createjs.Text(d,this.styleState2.textCss,this.styleState2.textColor);f.lineWidth=this.styleState2.width-this.paddingState2.left-this.paddingState2.right;f.textAlign="center";this.state2Height+=f.getMeasuredHeight();if(g){this.state2Height+=this.paddingState2.top/2}}var e=new createjs.Graphics();e.beginFill(this.styleState2.bgColor);e.setStrokeStyle(this.styleState2.borderWidth).beginStroke(this.styleState2.borderColor);e.drawRoundRect(0,0,this.styleState2.width,this.state2Height,this.styleState2.cornerRadius);var c=new createjs.Shape(e);c.x=-this.styleState2.width/2;c.y=-this.state2Height/2;this.state2.addChild(c);if(g){g.x=c.x+this.styleState2.width/2;g.y=c.y+this.paddingState2.top;this.state2.addChild(g)}if(f){f.x=c.x+this.styleState2.width/2;f.y=c.y+this.state2Height-f.getMeasuredHeight()-this.paddingState2.bottom;this.state2.addChild(f)}};b.getMarginedHeight=function(){if(this.state1.visible){return this.state1Height+this.marginState1.top+this.marginState1.bottom}else{if(this.state2.visible){return this.state2Height+this.marginState2.top+this.marginState2.bottom}else{return this.state0Height}}};b.getMarginedWidth=function(){if(this.state1.visible){return this.styleState1.width+this.marginState1.top+this.marginState1.bottom}else{if(this.state2.visible){return this.styleState2.width+this.marginState1.left+this.marginState1.right}else{return this.state0Height}}};b.select=function(){this.state0.visible=false;this.state0inactive.visible=false;this.state1.visible=false;this.state2.visible=true};b.deselect=function(){this.state0.visible=false;this.state0inactive.visible=false;this.state1.visible=true;this.state2.visible=false};b.minimize=function(c){this.state1.visible=false;this.state2.visible=false;if(!c){this.state0.visible=true;this.state0inactive.visible=false}else{this.state0.visible=false;this.state0inactive.visible=true}};b._tick=function(){};argunet.SelectableView=a}());this.argunet=this.argunet||{};argunet.ArgunetBrowserView=function(g,c,a,f){var e=this;this.canvasView=undefined;this.height100Percent=false;if(a&&a=="100%"){a=$(g).innerHeight();this.height100Percent=true}this.cWidth=c;this.cHeight=a||385;this.cHeight-=2;var b="argunetBrowser-"+f;this.htmlElement=$("<div id='"+b+"' class='argunetBrowser loading'></div>").appendTo(g).get(0);if(this.cWidth){this.cWidth-=2;$(this.htmlElement).width(this.cWidth)
}else{this.cWidth=$(this.htmlElement).width()}this.canvas=$("<canvas></canvas>").appendTo(this.htmlElement).get(0);$(this.canvas).width(this.cWidth).height(this.cHeight);this.canvas.width=this.cWidth;this.canvas.height=this.cHeight;this.doc=this.canvas.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;this.stage=new createjs.Stage(this.canvas);this.stage.mouseEventsEnabled=true;this.stage.enableMouseOver(20);if(createjs.Touch.isSupported()){createjs.Touch.enable(this.stage)}this.navigationBar=new argunet.NavigationBarView($(this.canvas).parent());this.navigationOpened=false;this.debateListView=new argunet.DebateListView($(this.canvas).parent(),f);console.log("naviHeight "+this.navigationBar.height);var d=new createjs.Container();this.stage.addChild(d);this.tooltip=new argunet.TooltipCanvasView(this.canvas);this.stage.addChild(this.tooltip);var e=this;$(this.canvas).parent().bind("mousedown touchstart",function(){e.showNavigationBar()});this.tooltip.addEventListener("mouseover",this);this.tooltip.addEventListener("mouseout",this);this.stage.addEventListener("stagemousemove",this);this.navigationBar.addEventListener("openDebateList",this);this.navigationBar.addEventListener("closeDebateList",this);this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.navigationBar.addEventListener("screenshot",this);this.navigationBar.addEventListener("openFullscreen",this);this.navigationBar.addEventListener("closeFullscreen",this);this.resize()};argunet.ArgunetBrowserView.prototype.showNavigationBar=function(){window.clearTimeout(this.navigationBarTimeout);if(!this.navigationOpened){this.navigationBar.show();this.navigationOpened=true}var a=this;this.navigationBarTimeout=window.setTimeout(function(){if(a.navigationOpened&&!a.debateListView.isOpen&&a.stage.mouseY<a.canvas.height-a.navigationBar.height){a.navigationBar.hide();a.navigationOpened=false}window.clearTimeout(a.navigationBarTimeout)},3500)};argunet.ArgunetBrowserView.prototype.handleEvent=function(b){var e=this;if(b.type=="showTooltip"){this.tooltipTimeout=window.setTimeout(function(){e.tooltip.setContent(b.tooltip);e.tooltip.setVisible(true);e.tooltip.x=Math.min($(e.stage.canvas).outerWidth()-5-e.tooltip.getWidth(),e.stage.mouseX+5);e.tooltip.y=Math.min(e.stage.canvas.height-5-e.tooltip.height,e.stage.mouseY+5);e.stage.update();window.clearTimeout(this.tooltipTimeout)},1000)}else{if(b.type=="hideTooltip"&&!this.mouseOverTooltip){window.clearTimeout(this.tooltipTimeout);this.tooltip.setVisible(false);this.stage.update()}else{if(b.type=="screenshot"){this.takeScreenshot(b.replaceCanvas)}else{if(b.type=="mousedown"){if(!this.mouseOverTooltip){window.clearTimeout(this.tooltipTimeout);this.tooltip.setVisible(false);this.stage.update()}}else{if(b.type=="mouseover"&&b.target==this.tooltip){this.mouseOverTooltip=true}else{if(b.type=="mouseout"&&b.target==this.tooltip){this.mouseOverTooltip=false;this.tooltip.setVisible(false);this.stage.update()}else{if(b.type=="stagemousemove"){this.showNavigationBar()}else{if(b.type=="openDebateList"){this.debateListView.show()}else{if(b.type=="closeDebateList"){this.debateListView.hide();this.showNavigationBar()}else{if(b.type=="openFullscreen"){var f=$(this.canvas).parent().get(0);var a=f.requestFullscreen||f.webkitRequestFullscreen||f.mozRequestFullScreen;if(a){a.call(f)}}else{if(b.type=="closeFullscreen"){var a=this.doc.exitFullscreen||this.doc.webkitExitFullscreen||this.doc.mozCancelFullScreen;if(a){a.call(this.doc)}}else{if(b.type=="resize"||b.type=="fullscreenchange"||b.type=="mozfullscreenchange"||b.type=="webkitfullscreenchange"){var g=this.canvas;if(this.doc.mozFullScreen||this.doc.webkitIsFullScreen){var d=g.getBoundingClientRect();$(g).width(d.width);$(g).height(d.height);this.canvas.width=d.width;this.canvas.height=d.height}else{if(this.oldWidth&&this.oldHeight&&this.oldWidth==$(this.htmlElement).innerWidth()&&this.oldHeight==$(this.htmlElement).parent().innerHeight-2){return
}this.resize()}}}}}}}}}}}}}};argunet.ArgunetBrowserView.prototype.resize=function(){this.cWidth=$(this.htmlElement).innerWidth();if(this.height100Percent){this.cHeight=$(this.htmlElement).parent().innerHeight()-2}if(this.cWidth<450){this.debateListView.setHeight(this.cHeight-100+2)}else{this.debateListView.setHeight(this.cHeight-50+2)}$(this.canvas).width(this.cWidth);$(this.canvas).height(this.cHeight);this.canvas.width=this.cWidth;this.canvas.height=this.cHeight;this.oldWidth=this.canvas.width;this.oldHeight=this.canvas.height};argunet.ArgunetBrowserView.prototype.removeLoadingSpinner=function(){$(this.canvas).parent().removeClass("loading")};argunet.ArgunetBrowserView.prototype.takeScreenshot=function(b){var d=this.canvas.toDataURL();$(this.screenshot).children("img").attr("src",d);if(b){var a=$(this.htmlElement).css("width");$(this.htmlElement).hide();if($(this.htmlElement).next().is(".argunetBrowser.screenshot")){$(this.htmlElement).next().remove()}var c=$("<div class='argunetBrowser screenshot'><img src='"+d+"' /></div>").insertAfter(this.htmlElement);$(c).css("width",a);$(c).css("height","auto")}else{$("<div class='argunet dialog screenshot' title='Screenshot of the current argument map'><img src='"+d+"' /></div>").dialog({width:"auto",document:this.doc,window:this.win}).children("img").css("max-width","100%")}};this.argunet=this.argunet||{};(function(){var a=function(b,c,d){this.initialize(b,c,d)};a.prototype=new createjs.Container();a.prototype.Container_initialize=a.prototype.initialize;a.prototype.Container_tick=a.prototype._tick;a.prototype.initialize=function(b,c,d){this.Container_initialize();this.color=(b.type==undefined||b.type.toLowerCase()=="attack"||b.type.toLowerCase()=="sketchedattack")?"#D9000E":"#54BC11";this.edge=b;this.source=c;this.target=d};a.prototype.render=function(r,s){this.removeAllChildren();var m=18;var k=5;var q=5;var i=1;var h=Math.atan2(s.y-r.y,s.x-r.x);var f=h*(180/Math.PI);var p=s.x-r.x;var o=s.y-r.y;var n=Math.sqrt(p*p+o*o);n=n-m+q;var d=n*Math.cos(h);var u=n*Math.sin(h);d+=r.x;u+=r.y;var l=new createjs.Graphics();l.setStrokeStyle(i).beginStroke(this.color).moveTo(r.x,r.y).lineTo(d,u).endStroke();var j=new createjs.Shape(l);this.addChild(j);var t=new createjs.Graphics();t.beginFill(this.color).moveTo(-m,k).lineTo(0,0).lineTo(-m,-k).lineTo(-m+q,-0).closePath().endFill();var e=new createjs.Shape(t);e.x=s.x;e.y=s.y;e.rotation=f;this.addChild(e)};a.prototype._tick=function(){};argunet.ArrowCanvasView=a}());this.argunet=this.argunet||{};(function(){var a=function(d,c){this.initialize(d,c)};var b=a.prototype=new argunet.SelectableView();b.Selectable_initialize=a.prototype.initialize;b.Selectable_tick=a.prototype._tick;b.initialize=function(d,c){this.Selectable_initialize(d.id,d.title,d.description,c);this.argument=d;this.render()};argunet.ArgumentCanvasView=a}());this.argunet=this.argunet||{};(function(){var a=function(d,c){this.initialize(d,c)};var b=a.prototype=new argunet.SelectableView();b.Selectable_initialize=a.prototype.initialize;b.Selectable_tick=a.prototype._tick;b.initialize=function(d,c){this.Selectable_initialize(d.id,d.title,d.content,c);this.thesis=d;this.styleState1.borderColor=this.styleState2.borderColor=this.colors.base;this.styleState1.borderWidth=2;this.styleState2.borderWidth=4;this.styleState1.bgColor=this.styleState2.bgColor="#ffffff";this.styleState1.textColor=this.styleState2.textColor=this.styleState1.titleColor=this.styleState2.titleColor="#000000";this.marginState1.top=this.marginState1.right=this.marginState1.bottom=this.marginState1.left=1;this.marginState2.top=this.marginState2.right=this.marginState2.bottom=this.marginState2.left=2;this.render()};argunet.ThesisCanvasView=a}());this.argunet=this.argunet||{};argunet.ArborView=function(a,h){var l=a;var b=argunet.ArborView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);var j=null;
this.stage;var i={};var d={};var g=undefined;var c=undefined;var k=undefined;this.stage=h;this.stage.clear();k=new createjs.Container();this.stage.addChild(k);c=new createjs.Container();this.stage.addChild(c);this.init=function(m){j=m;j.screenSize(this.stage.canvas.width,this.stage.canvas.height);j.screenPadding(40)};this.handleEvent=function(m){var s=this.stage.canvas.ownerDocument;if(m.type=="select"){this.dispatchEvent({type:"nodeSelection",nodeId:m.target.nodeId},m.target)}else{if(m.type=="mouseover"){s.body.style.cursor="pointer";var t="<h3>"+m.target.title+"</h3><p>"+m.target.text+"</p>";var n;if(m.target instanceof argunet.ArgumentCanvasView||m.target instanceof argunet.ThesisCanvasView){if(m.target instanceof argunet.ArgumentCanvasView){n=m.target.argument}else{n=m.target.thesis}t+="<table class='relations'><tr><td class='incoming-attacks'><span class='icon-incoming-attacks'></span><span class='label'>"+n.relations.incomingAttacks+"</span></td><td class='incoming-supports'><span class='icon-incoming-supports'></span><span class='label'>"+n.relations.incomingSupports+"</span></td></tr><tr><td class='outgoing-attacks'><span class='icon-outgoing-attacks'></span><span class='label'>"+n.relations.outgoingAttacks+"</span></td><td class='outgoing-supports'><span class='icon-outgoing-supports'></span><span class='label'>"+n.relations.outgoingSupports+"</span></td></tr></table>"}else{if(m.target instanceof argunet.GroupCanvasView){if(m.target.state2.visible){t+="<p class='tip'>(double click group to open the group and show its members.)</p>"}}}this.dispatchEvent({type:"showTooltip",tooltip:t},m.target)}else{if(m.type=="mouseout"){s.body.style.cursor="default";this.dispatchEvent("hideTooltip",m.target)}else{if(m.type=="mousedown"){this.dispatchEvent({type:"mousedown",nodeId:m.target.nodeId},m.target)}else{if(m.type=="drag"){s.body.style.cursor="move";var q=m.target;var o=j.getNode(m.target.nodeId);o.fixed=true;var r={x:q.x,y:q.y};r=j.fromScreen(r);o.p=r}else{if(m.type=="drop"){s.body.style.cursor="default";var q=m.target;var o=j.getNode(m.target.nodeId);o.fixed=false;o.tempMass=50}else{if(m.type=="dblclick"){this.dispatchEvent(m,m.target)}}}}}}}};this.selectNode=function(m){if(g!=undefined){g.deselect()}g=i[m];g.select()};this.redraw=function(){var n=this;if(!j){return}$.each(i,function(){var p=this.nodeId;if(j.getNode(p)==undefined){var o=i[p];if(g!=undefined&&o.nodeId==g.nodeId){g=undefined}o.removeEventListener(n);c.removeChild(o);delete i[p]}});$.each(d,function(){$.each(this,function(){if(j.getEdgesFrom(this.source)[this.target]==undefined){var o=d[this.source][this.target];k.removeChild(o);delete d[this.source][this.target]}})});var m={};j.eachNode(function(p,s){var r=i[p.data.id];if(i[p.data.id]==undefined){var t;t=l.getNode(p.data.id);if(t instanceof argunet.Argument){r=new argunet.ArgumentCanvasView(t,l.getColor(t.colorIndex))}else{if(t instanceof argunet.Thesis){r=new argunet.ThesisCanvasView(t,l.getColor(t.colorIndex))}}r.addEventListener("select",n);r.addEventListener("mousedown",n);r.addEventListener("dblclick",n);r.addEventListener("mouseover",n);r.addEventListener("mouseout",n);r.addEventListener("drag",n);r.addEventListener("drop",n);i[p.data.id]=r;c.addChild(r)}var r=i[p.data.id];s.x=Math.floor(s.x);s.y=Math.floor(s.y);r.x=s.x;r.y=s.y;var o=r.getMarginedWidth();var q=r.getMarginedHeight();m[p.data.id]=[s.x-o/2,s.y-q/2,o,q];if(p.data.selected&&!p.data.inactive){n.selectNode(p.data.id)}else{if(p.data.inactive){r.minimize(true)}else{if(p.data.edgesToSelectedNode>1){r.minimize(false)}else{if(p.data.edgesToSelectedNode>0&&!p.data.inactive){r.deselect()}}}}});j.eachEdge(function(p,s,r){var o=m[p.data.target];var v={x:s.x,y:s.y};var u=f(v,r,o);var t=(d[p.data.source])?d[p.data.source][p.data.target]:undefined;if(t==undefined){if(d[p.data.source]==undefined){d[p.data.source]={}}var q=l.getEdge(p.data.sourceModel,p.data.targetModel);var t=new argunet.ArrowCanvasView(q,p.data.source,p.data.target);d[p.data.source][p.data.target]=t;
k.addChild(t)}t.render(v,u)});this.stage.update()};var e=function(s,r,q,p){var m=((p.y-q.y)*(r.x-s.x)-(p.x-q.x)*(r.y-s.y));if(m===0){return false}var o=((p.x-q.x)*(s.y-q.y)-(p.y-q.y)*(s.x-q.x))/m;var n=((r.x-s.x)*(s.y-q.y)-(r.y-s.y)*(s.x-q.x))/m;if(o<0||o>1||n<0||n>1){return false}return arbor.Point(s.x+o*(r.x-s.x),s.y+o*(r.y-s.y))};var f=function(t,s,m){var q={x:m[0],y:m[1]},r=m[2],o=m[3];var v={x:q.x,y:q.y};var p={x:q.x+r,y:q.y};var n={x:q.x,y:q.y+o};var u={x:q.x+r,y:q.y+o};return e(t,s,v,p)||e(t,s,p,u)||e(t,s,u,n)||e(t,s,n,v)||false}};this.argunet=this.argunet||{};argunet.StaticGraphView=function(a){var d=argunet.StaticGraphView.prototype;d.addEventListener=null;d.removeEventListener=null;d.removeAllEventListeners=null;d.dispatchEvent=null;d.hasEventListener=null;d._listeners=null;createjs.EventDispatcher.initialize(d);this.stage=a;this.stage.clear();this.container=new createjs.Container();this.edgeLayer=new createjs.Container();this.container.addChild(this.edgeLayer);this.nodeLayer=new createjs.Container();this.container.addChild(this.nodeLayer);this.stage.addChild(this.container);this.nodeViews={};this.edgeViews={};this.selectedNode=undefined;this.handleEvent=function(e){var g=this.stage.canvas.ownerDocument;if(e.type=="select"){this.dispatchEvent({type:"nodeSelection",nodeId:e.target.nodeId},e.target)}else{if(e.type=="mouseover"){g.body.style.cursor="pointer";var h="<h3>"+e.target.title+"</h3><p>"+e.target.text+"</p>";var f;if(e.target instanceof argunet.ArgumentCanvasView||e.target instanceof argunet.ThesisCanvasView){if(e.target instanceof argunet.ArgumentCanvasView){f=e.target.argument}else{f=e.target.thesis}h+="<table class='relations'><tr><td class='incoming-attacks'><span class='icon-incoming-attacks'></span><span class='label'>"+f.relations.incomingAttacks+"</span></td><td class='incoming-supports'><span class='icon-incoming-supports'></span><span class='label'>"+f.relations.incomingSupports+"</span></td></tr><tr><td class='outgoing-attacks'><span class='icon-outgoing-attacks'></span><span class='label'>"+f.relations.outgoingAttacks+"</span></td><td class='outgoing-supports'><span class='icon-outgoing-supports'></span><span class='label'>"+f.relations.outgoingSupports+"</span></td></tr></table>"}else{if(e.target instanceof argunet.GroupCanvasView){if(e.target.state2.visible){h+="<p class='tip'>(double click group to open the group and show its members.)</p>"}}}this.dispatchEvent({type:"showTooltip",tooltip:h},e.target)}else{if(e.type=="mouseout"){g.body.style.cursor="default";this.dispatchEvent("hideTooltip",e.target)}else{if(e.type=="mousedown"){this.dispatchEvent({type:"mousedown",nodeId:e.target.nodeId},e.target)}else{if(e.type=="drag"){g.body.style.cursor="move"}else{if(e.type=="drop"){g.body.style.cursor="default"}else{if(e.type=="dblclick"){this.dispatchEvent(e,e.target)}}}}}}}};this.selectNode=function(e){};this.redraw=function(g,f,e){var h=this;$.each(g,function(i,j){var k;if(j instanceof argunet.Argument){k=new argunet.ArgumentCanvasView(j,e[j.colorIndex])}else{if(j instanceof argunet.Thesis){k=new argunet.ThesisCanvasView(j,e[j.colorIndex])}}h.nodeViews[i]=k;h.nodeLayer.addChild(k);k.x=j.x;k.y=j.y});$.each(f,function(i,j){h.edgeViews[j.source]=h.edgeViews[j.source]||{};h.edgeViews[j.source][j.target]=new argunet.ArrowCanvasView(j,j.source,j.target);h.edgeLayer.addChild(h.edgeViews[j.source][j.target])});this.stage.update()};var c=function(k,j,i,h){var e=((h.y-i.y)*(j.x-k.x)-(h.x-i.x)*(j.y-k.y));if(e===0){return false}var g=((h.x-i.x)*(k.y-i.y)-(h.y-i.y)*(k.x-i.x))/e;var f=((j.x-k.x)*(k.y-i.y)-(j.y-k.y)*(k.x-i.x))/e;if(g<0||g>1||f<0||f>1){return false}return arbor.Point(k.x+g*(j.x-k.x),k.y+g*(j.y-k.y))};var b=function(m,l,e){var j={x:e[0],y:e[1]},k=e[2],g=e[3];var o={x:j.x,y:j.y};var i={x:j.x+k,y:j.y};var f={x:j.x,y:j.y+g};var n={x:j.x+k,y:j.y+g};return c(m,l,o,i)||c(m,l,i,n)||c(m,l,n,f)||c(m,l,f,o)||false}};this.argunet=this.argunet||{};(function(){var a=function(c){this.initialize(c)};var b=a.prototype=new createjs.Container();
b.Container_initialize=a.prototype.initialize;b.Container_tick=a.prototype._tick;b.initialize=function(c){this.Container_initialize();$(c).parent().append("<div class='argunet-tooltip'>Dies ist ein Tooltip</div>");this.tooltip=$(c).parent().children(".argunet-tooltip").get(0);var e=new createjs.DOMElement(this.tooltip);this.addChild(e);this.x=50;this.y=50;this.setVisible(false);var d=this;$(this.tooltip).mouseenter(function(f){d.dispatchEvent("mouseover",d)});$(this.tooltip).mouseleave(function(f){d.dispatchEvent("mouseout",d)})};b.getWidth=function(){return $(this.tooltip).outerWidth()};b.setContent=function(c){$(this.tooltip).empty();$(this.tooltip).append(c);this.height=$(this.tooltip).outerHeight()};b.setVisible=function(c){if(c){this.visible=true;$(this.tooltip).show()}else{this.visible=false;$(this.tooltip).hide()}};b._tick=function(){this.Container_tick()};argunet.TooltipCanvasView=a}());this.argunet=this.argunet||{};argunet.NavigationBarView=function(d){var b=argunet.NavigationBarView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);var g="Open Debate List";this.fullscreenApiImplemented=false;var e=typeof d.get(0).requestFullscreen=="function"||typeof d.get(0).webkitRequestFullscreen=="function"||typeof d.get(0).mozRequestFullScreen=="function";var i=typeof document.exitFullscreen=="function"||typeof document.webkitExitFullscreen=="function"||typeof document.mozCancelFullScreen=="function";var h=document.fullScreen!=undefined||document.webkitIsFullScreen!=undefined||document.mozFullScreen!=undefined;if(e&&i&&h){this.fullscreenApiImplemented=true}var c="";if(this.fullscreenApiImplemented){c="<div class='fullscreen menuItem'>Fullscreen</div>"}$(d).append("<div class='navigationBar'><div class='menu'><div class='back menuItem'>Back</div><div class='home menuItem'>Home</div><div class='forward menuItem'>Forward</div><div class='openList menuItem'>"+g+"</div><div class='decreaseDepth menuItem'>Decrease Depth</div><div class='graphDepth menuItem'><div class='label'>Graph Depth: <span class='graphDepthLabel'>1</span></div><div class='slider'></div></div><div class='increaseDepth menuItem'>Increase Depth</div><div class='screenshot menuItem'>Screenshot</div>"+c+"</div><a href='http://www.argunet.org' class='logo'><span>Argunet</span></a></div>");this.htmlElement=$(d).children(".navigationBar").get(0);this.doc=this.htmlElement.ownerDocument;this.win="defaultView" in this.doc?this.doc.defaultView:this.doc.parentWindow;var f=this;var a=$(this.htmlElement).find(".graphDepth .slider");$(this.htmlElement).find(".buttons").buttonset();openListButton=$(this.htmlElement).find(".openList");openListButton.button().click(function(){var j=$(this).button("option","label");if(j==g){$(this).button("option","label","Close Debate List");f.dispatchEvent({type:"openDebateList"},f)}else{$(this).button("option","label",g);f.dispatchEvent({type:"closeDebateList"},f)}});$(this.htmlElement).find(".back").button({icons:{primary:"ui-icon-circle-triangle-w"},text:false}).click(function(){f.dispatchEvent({type:"back"},f)});$(this.htmlElement).find(".home").button({icons:{primary:"ui-icon-home"},text:false}).click(function(){f.dispatchEvent({type:"home"},f)});$(this.htmlElement).find(".forward").button({icons:{primary:"ui-icon-circle-triangle-e"},text:false}).click(function(){f.dispatchEvent({type:"forward"},f)});$(this.htmlElement).find(".decreaseDepth").button({icons:{primary:"ui-icon-circle-minus"},text:false}).click(function(){var j=parseInt($(f.htmlElement).find(".graphDepthLabel").text());f.dispatchEvent({type:"graphDepthChange",value:j-1},f)});$(this.htmlElement).find(".increaseDepth").button({icons:{primary:"ui-icon-circle-plus"},text:false}).click(function(){var j=parseInt($(f.htmlElement).find(".graphDepthLabel").text());f.dispatchEvent({type:"graphDepthChange",value:j+1},f)});$(this.htmlElement).find(".screenshot").button({icons:{primary:"ui-icon-image"},text:false}).click(function(){f.dispatchEvent({type:"screenshot"},f)
});if(this.fullscreenApiImplemented){this.fullscreenLabel="Fullscreen";this.exitFullscreenLabel="Exit Fullscreen";this.fullscreenButton=$(this.htmlElement).find(".fullscreen");this.fullscreenButton.button({icons:{primary:"ui-icon-arrow-4-diag"},text:false}).click(function(){var j=$(this).button("option","label");if(j==f.fullscreenLabel){f.dispatchEvent({type:"openFullscreen"},f)}else{f.dispatchEvent({type:"closeFullscreen"},f)}})}this.height=$(this.htmlElement).height();this.doc.addEventListener("fullscreenchange",this);this.doc.addEventListener("mozfullscreenchange",this);this.doc.addEventListener("webkitfullscreenchange",this);this.win.addEventListener("resize",this,false);this.updateHeight();$(this.htmlElement,this.doc).hide()};argunet.NavigationBarView.prototype.handleEvent=function(a){if(a.type=="fullscreenchange"||a.type=="mozfullscreenchange"||a.type=="webkitfullscreenchange"){if(this.doc.fullScreen||this.doc.webkitIsFullScreen||this.doc.mozFullScreen){this.fullscreenButton.button("option","label",this.exitFullscreenLabel);this.fullscreenButton.button("option","icons",{primary:"ui-icon-exit-fullscreen"})}else{this.fullscreenButton.button("option","label",this.fullscreenLabel);this.fullscreenButton.button("option","icons",{primary:"ui-icon-arrow-4-diag"})}}else{if(a.type=="resize"){this.updateHeight()}else{if(a.type=="graphDepthChange"){$(this.htmlElement).find(".graphDepthLabel").text(a.value)}}}};argunet.NavigationBarView.prototype.updateHeight=function(){var a=$(this.htmlElement).width();if(a>580){$(this.htmlElement).children(".logo").show()}else{if(a<580&&a>450){$(this.htmlElement).css("height","50px");$(this.htmlElement).children(".logo").hide()}else{$(this.htmlElement).children(".logo").hide();$(this.htmlElement).css("height","100px")}}};argunet.NavigationBarView.prototype.show=function(){$(this.htmlElement).show("slide",{direction:"down"},600)};argunet.NavigationBarView.prototype.hide=function(){$(this.htmlElement).hide("slide",{direction:"down"},600)};argunet.NavigationBarView.prototype.setBackwardEnabled=function(a){$(this.htmlElement).find(".back").button({disabled:!a})};argunet.NavigationBarView.prototype.setForwardEnabled=function(a){$(this.htmlElement).find(".forward").button({disabled:!a})};argunet.NavigationBarView.prototype.setHomeEnabled=function(a){$(this.htmlElement).find(".home").button({disabled:!a})};this.argunet=this.argunet||{};argunet.DebateListView=function(d,c){var b=argunet.DebateListView.prototype;b.addEventListener=null;b.removeEventListener=null;b.removeAllEventListeners=null;b.dispatchEvent=null;b.hasEventListener=null;b._listeners=null;createjs.EventDispatcher.initialize(b);this.zTreeId="argunetBrowser"+c+"-ztree";d.append("<div class='debateList'><div id='"+this.zTreeId+"' class='tree ztree'></div></div>");this.htmlElement=$(d).children(".debateList").get(0);var a=this;$(this.htmlElement).hide()};argunet.DebateListView.prototype.initialize=function(f,b,e){if(b){$(this.htmlElement).prepend("<h4>"+b+"</h4>")}$(this.htmlElement).prepend("<h3>"+f+"</h3>");$(this.htmlElement).hide();var d=this;var c=function(h,j,i){if(i.nodeId!=undefined){d.dispatchEvent({type:"nodeSelection",nodeId:i.nodeId},d)}};var g=function(h,j,i){if(i.checked){d.dispatchEvent({type:"openGroup",id:i.id},this)}else{d.dispatchEvent({type:"closeGroup",id:i.id},this)}};var a={callback:{onClick:c,onCheck:g},check:{enable:false,chkboxType:{Y:"ps",N:"ps"}}};this.zTree=$.fn.zTree.init($(this.htmlElement).children("#"+this.zTreeId),a,e)};argunet.DebateListView.prototype.setHeight=function(a){this.height=a;$(this.htmlElement).height(this.height)};argunet.DebateListView.prototype.show=function(){$(this.htmlElement).show("slide",{direction:"left"},600);this.isOpen=true};argunet.DebateListView.prototype.hide=function(){$(this.htmlElement).hide("slide",{direction:"left"},600);this.isOpen=false};this.argunet=this.argunet||{};(function(){var b=function(c){this.initialize(c)};var a=b.prototype=new argunet.SelectableView();a.Selectable_initialize=b.prototype.initialize;
a.Selectable_tick=b.prototype._tick;a.initialize=function(d){var c=d.numberOfArguments+d.numberOfTheses;this.Selectable_initialize(d.id,"Group: "+d.title,c+" Members",{base:d.color,dark:"#666",light:d.color});this.group=d;this.styleState2.textCss="bold 18px Arial";this.styleState2.borderWidth=1;this.styleState1.borderWidth=1;this.styleState1.cornerRadius=20;this.styleState2.cornerRadius=35;this.styleState0.cornerRadius=10;this.state0Height=25;this.paddingState1={top:12,left:12,bottom:12,right:12};this.paddingState2={top:20,left:20,bottom:20,right:20};this.render()};argunet.GroupCanvasView=b}());this.argunet=this.argunet||{};argunet.ErrorMessageView=function(f,d,a,g,e){var c=d||640;var b=a||385;if(typeof(f)=="string"){f=$(f)}if(!$(f).children(".argunetBrowser").length){$(f).append("<div class='argunetBrowser'></div>")}$(f).children(".argunetBrowser:first").width(c).height(b).empty().addClass("error").append("<div class='error'><a href='http://www.argunet.org' class='logo'><span>Argunet Browser</span></a><h3>"+g+"</h3><p>"+e+"</p><p><a href='http://www.argunet.org'>www.argunet.org</a></p></div>")};this.argunet=this.argunet||{};argunet.ArgunetBrowser=function(v,j,r,n,k,b,q,c,a,l){if(typeof v=="object"){var u=v;v=u.data;j=u.container;r=u.firstNode;n=u.width;k=u.height;b=u.jsUrl;q=u.cssUrl;c=u.embedded||true;a=u.graphType;l=u.graphDepth}k=k||385;q=q||"http://christianvoigt.github.com/ArgunetBrowser/lib/ArgunetBrowser.min.css";this.graphType=a||"arbor";this.initialGraphDepth=l||1;var f=this;var m=argunet.ArgunetBrowser.prototype;m.addEventListener=null;m.removeEventListener=null;m.removeAllEventListeners=null;m.dispatchEvent=null;m.hasEventListener=null;m._listeners=null;createjs.EventDispatcher.initialize(m);this.w=(c)?window.parent:window;$("#lightningjs-argunet",this.w.document).css("display","block").css("width","0").css("height","0").css("frameborder","0");this.browserId=argunet.BrowserRegistry.getInstance(this.w).registerBrowser(this);if(j){this.container=(typeof j=="string")?$(j,this.w.document).get(0):j}else{var g=argunet.BrowserRegistry.getInstance(this.w).getScriptTag(this.browserId);$(g).after("<div></div>");this.container=$(g).next("div").get(0)}if(!v){$(this.container).children().hide()}if(!Modernizr.canvas||!Modernizr.canvastext||!({}).__defineGetter__){new argunet.ErrorMessageView(j,n,k,"Argunet Browser not initialized","We detected that your browser lacks features <a href='http://www.argunet.org'>Argunet Browser</a> depends on. Please use an up-to-date browser that supports HTML5, CSS3 and the Canvas Element.");return}if(!b){$("script").each(function(){var p=$(this).attr("src");var e=-1;if(p){e=p.indexOf("ArgunetBrowser.embed.min.js")}if(e!==-1){b=$(this).attr("src").substring(0,e);return false}})}this.jsUrl=b;var s=false;$("link[type='text/css']",this.w.document).each(function(){var e=$(this).attr("src");if(e){s=(e.indexOf("ArgunetBrowser.min.css")!=-1)}if(s){return false}});if(this.jsUrl&&!s){var d=q;if(!d){d=this.jsUrl+"ArgunetBrowser.min.css"}if(this.w.document.createStyleSheet){try{this.w.document.createStyleSheet(d)}catch(t){}}else{var i;i=this.w.document.createElement("link");i.rel="stylesheet";i.type="text/css";i.media="all";i.href=d;this.w.document.getElementsByTagName("head")[0].appendChild(i)}}this.onDebateLoad=function(){if(this.initialized==true){this.dispatchEvent({type:"update"},this)}else{this.debateListView=this.argunetView.debateListView;this.debateListController=new argunet.DebateListController(this.debateListView,this.debateManager);this.history=new argunet.History();if(this.graphType.toLowerCase()=="arbor"){this.arborView=new argunet.ArborView(this.debateManager,this.argunetView.stage);this.arborController=new argunet.ArborController(this.arborView,this.debateManager,this.jsUrl+"arbor.js");this.arborView.addEventListener("mousedown",this.argunetView);this.arborView.addEventListener("nodeSelection",this);this.arborView.addEventListener("mousedown",this);this.arborView.addEventListener("dblclick",this);
this.arborView.addEventListener("showTooltip",this.argunetView);this.arborView.addEventListener("hideTooltip",this.argunetView);this.arborView.addEventListener("mousedown",this.argunetView);this.arborView.addEventListener("openGroup",this.arborController);this.debateListView.addEventListener("nodeSelection",this.arborController);this.argunetView.navigationBar.addEventListener("graphDepthChange",this.arborController);this.addEventListener("graphDepthChange",this.arborController);this.addEventListener("update",this.arborController);this.history.addEventListener("historyChange",this.arborController);this.debateListView.addEventListener("openGroup",this.arborController);this.debateListView.addEventListener("closeGroup",this.arborController);this.debateListView.addEventListener("openAllGroups",this.arborController);this.debateListView.addEventListener("closeAllGroups",this.arborController)}else{this.staticGraphView=new argunet.StaticGraphView(this.argunetView.stage);this.staticGraphController=new argunet.StaticGraphController(this.staticGraphView,this.debateManager);this.staticGraphView.addEventListener("mousedown",this.argunetView);this.staticGraphView.addEventListener("nodeSelection",this);this.staticGraphView.addEventListener("mousedown",this);this.staticGraphView.addEventListener("dblclick",this);this.staticGraphView.addEventListener("showTooltip",this.argunetView);this.staticGraphView.addEventListener("hideTooltip",this.argunetView);this.staticGraphView.addEventListener("mousedown",this.argunetView);this.staticGraphView.addEventListener("openGroup",this.staticGraphController);this.debateListView.addEventListener("nodeSelection",this.staticGraphController);this.argunetView.navigationBar.addEventListener("graphDepthChange",this.staticGraphController);this.argunetView.navigationBar.addEventListener("update",this.staticGraphController);this.addEventListener("graphDepthChange",this.staticGraphController);this.history.addEventListener("historyChange",this.staticGraphController);this.debateListView.addEventListener("openGroup",this.staticGraphController);this.debateListView.addEventListener("closeGroup",this.staticGraphController);this.debateListView.addEventListener("openAllGroups",this.staticGraphController);this.debateListView.addEventListener("closeAllGroups",this.staticGraphController)}this.argunetView.navigationBar.addEventListener("back",this.history);this.argunetView.navigationBar.addEventListener("home",this.history);this.argunetView.navigationBar.addEventListener("forward",this.history);this.addEventListener("graphDepthChange",this.argunetView.navigationBar);this.argunetView.navigationBar.addEventListener("graphDepthChange",this.argunetView.navigationBar);this.addEventListener("screenshot",this.argunetView);this.history.addEventListener("historyChange",this);this.debateListView.addEventListener("nodeSelection",this);this.argunetView.removeLoadingSpinner();if(!this.firstNodeId){this.firstNodeId=this.debateManager.firstNodeId}this.initialized=true;this.selectNode(this.firstNodeId);this.setGraphDepth(this.initialGraphDepth)}};this.handleEvent=function(e){if(e.type=="debateLoaded"){this.onDebateLoad()}else{if(e.type=="error"){this.argunetView.removeLoadingSpinner();new argunet.ErrorMessageView(j,n,k,"Error",e.textStatus)}else{if(e.type=="historyChange"){this.argunetView.navigationBar.setBackwardEnabled(this.history.backwardEnabled);this.argunetView.navigationBar.setForwardEnabled(this.history.forwardEnabled);this.argunetView.navigationBar.setHomeEnabled(this.history.homeEnabled)}else{if(e.type=="nodeSelection"){this.history.selectNode(e.nodeId);this.dispatchEvent({type:"nodeSelection",nodeId:e.nodeId},e.target)}else{if(e.type=="mousedown"){this.dispatchEvent(e,e.target)}else{if(e.type=="dblclick"){this.dispatchEvent(e,e.target)}}}}}}};this.selectNode=function(e){if(this.initialized){this.history.selectNode(e)}else{this.firstNodeId=e}};this.setGraphDepth=function(e){if(this.initialized){this.dispatchEvent({type:"graphDepthChange",value:e},this)
}else{this.initialGraphDepth=e}};this.showScreenshot=function(){this.dispatchEvent({type:"screenshot",replaceCanvas:true},this)};this.loadDebate=function(){this.argunetView=new argunet.ArgunetBrowserView(this.container,n,k,this.browserId);this.firstNodeId=r;this.debateManager=new argunet.DebateManager(this.container);this.debateManager.addEventListener("debateLoaded",this);this.debateManager.addEventListener("error",this);this.debateManager.loadDebate(v)};this.reload=function(){this.firstNodeId=null;this.debateManager.loadDebate(v)};if($(this.container).is(":hidden")){var o;var h=function(){console.log("timeout");if(!$(f.container).is(":hidden")){f.loadDebate();clearTimeout(o)}else{o=setTimeout(h,100)}};h()}else{this.loadDebate()}};